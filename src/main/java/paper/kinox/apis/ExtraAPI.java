...
/**
 * API extra cheia de funcionalidades que sempre ser� preciso de uma forma
 * simplificada
 * 
 * @author Eduard
 *
...
public final class ExtraAPI {
	...
	public static String formatTime(long time) {
		return paper.kinox.apis.ObjectAPI.formatTime(time);
	}
	...
	public static long parseDateDiff(String time, boolean future)
			throws Exception {
		return paper.kinox.apis.ObjectAPI.parseDateDiff(time, future);
	}
