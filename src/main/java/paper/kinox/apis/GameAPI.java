...
//	    double threshold = 1.0D;
	...
	public static Player getRandomPlayer(List<Player> list){
		return list.get(paper.kinox.apis.ExtraAPI.getRandomInt(1, list.size())-1);
	}
	...
	public static List<Player> getPlayers() {
		return paper.kinox.apis.RexAPI.getPlayers();
	}
	...
	public static void makeInvunerable(Player player) {
		player.setNoDamageTicks(paper.kinox.apis.ObjectAPI.DAY_IN_SECONDS * 20);
	...
	public static void changeTabName(Player player, String displayName) {
		player.setPlayerListName(paper.kinox.apis.ExtraAPI.toText(displayName));
	}
	...
	public static void resetScoreboard(Player player) {
		player.setScoreboard(paper.kinox.apis.ExtraAPI.getMainScoreboard());
	}
	// Parei aqui
	...
	public static boolean isFalling(Entity entity) {
		return entity.getVelocity().getY() < paper.kinox.apis.ObjectAPI.WALKING_VELOCITY;
	}
